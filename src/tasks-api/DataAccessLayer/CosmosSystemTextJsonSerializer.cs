...
public class CosmosSystemTextJsonSerializer : CosmosSerializer
{
    public override T FromStream<T>(Stream stream)
    {
        using (stream)
        {
            ...
            return (T)JsonSerializer.Deserialize(memoryStream.ToArray(), typeof(T), TasksJsonSerializerContext.Default);
        }
    }
    ...
    public override Stream ToStream<T>(T input)
    {
        ...
        var buffer = JsonSerializer.SerializeToUtf8Bytes(input, input.GetType(), TasksJsonSerializerContext.Default);
